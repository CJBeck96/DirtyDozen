            ...
            if line:
                ...
                if line.count(",") == 3:  # Expecting exactly three commas (4 fields)
                    try:
                        ...
                        split_time_formatted = "N/A"  # Default for first lap
                        if tag_id in racers_data:
                            ...
                            split_time_formatted = format_time(abs(split_time))  # Show absolute time difference
                            if split_time < 0:
                                split_time_formatted = "-" + split_time_formatted  # Add negative sign for faster laps
                        
                        # Update racer data with new lap times
                        racers_data[tag_id] = {
